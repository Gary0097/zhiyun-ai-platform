  ...
  function DataBrowser() {
    ...
    return h("div", { style: { padding: 28, height: "100%", overflow: "auto", background: "#f7f8fa" } },
      h("div", { style: { maxWidth: 1400, margin: "0 auto" } },
        ...
        h(antd.Collapse, { style: { marginBottom: 16 }, items: [{ key: "guide", label: "功能引导与使用说明", children: h("div", null, h("p", null, "功能介绍：集中管理所有制造云应用共享的数据、字段、导入批次、演示数据、健康检查和安全备份。"), h("ol", null, h("li", null, "用“导入 Excel/CSV”导入正式业务数据并核对字段。"), h("li", null, "可在“数据环境”中切换演示/正式；生成的演示数据可按批次撤销。"), h("li", null, "新增或调整字段请在字段管理中完成，核心字段受保护。"), h("li", null, "恢复备份前必须确认，系统会先创建安全备份。"))) }] }),
