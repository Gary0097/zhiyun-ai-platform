...
@media (min-width: 900px) {
  ...
  .qwenpaw-app:has(form) .qwenpaw-app > *{grid-column:1 / -1 !important;}
...
@media (max-width: 899px){
  ...
  .qwenpaw-app:has(form){display:flex !important;flex-direction:column !important;justify-content:center !important;align-items:center !important;min-height:100vh !important;padding:24px 16px !important;box-sizing:border-box !important;overflow-x:hidden !important;}
  .qwenpaw-app:has(form) > *,.qwenpaw-app:has(form) > * > *,.qwenpaw-app:has(form) > * > * > *{width:100% !important;max-width:400px !important;padding-left:0 !important;padding-right:0 !important;box-sizing:border-box !important;}
